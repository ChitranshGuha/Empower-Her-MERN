    ...
    <div className="container-fluid py-4" id="section7" style={{ backgroundColor: '#d9faff', marginTop: '20px' }}>
      <div className="row align-items-center justify-content-center">
        ...
        <div className="col-md-5 p-4"> 
          <p className="text-primary fw-bold mb-3" style={{ fontSize: '2vw', fontFamily: 'Gill Sans, Gill Sans MT, Calibri, Trebuchet MS, sans-serif' }}>Have any Queries? Contact Us...</p> 
          <p className="lead mb-4" style={{ fontSize: '1.2vw' }}>Feel free to reach out to us, We are 24x7 available for your help</p> 

          <form id="userinfo" onSubmit={handleQuerySubmit}>
            <div className="mb-3">
              <input type="text" id="username" name="username" placeholder="Name" className="form-control" required /> 
            </div>
            <div className="mb-3">
              <input type="tel" id="phone" name="phone" placeholder="Phone Number" className="form-control" required /> 
            </div>
            <div className="mb-3">
              <input type="email" id="email" name="email" placeholder="Email" className="form-control" required /> 
            </div>
            <div className="mb-4">
              <textarea id="query" name="query" placeholder="Enter your query message" rows="4" className="form-control" required></textarea> 
            </div>
            <button type="submit" className="btn btn-success rounded-pill px-4 py-2" disabled={loading}> 
