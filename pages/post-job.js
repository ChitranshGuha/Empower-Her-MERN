  ...
  useEffect(() => {
    if (jobIdToEdit) {
      ...
      async function fetchJobData() {
        try {
          const res = await fetch(`/api/jobs/${jobIdToEdit}`);
          ...
          <div className="card glass-effect border-0 shadow-lg rounded-4 overflow-hidden">
            <div className="gradient-header text-white text-center py-5 position-relative floating-elements">
              ...
              <div className="position-relative" style={{ zIndex: 10 }}>
                ...
                <p className="lead mx-auto" style={{ maxWidth: "600px", color: "#e3f2fd" }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  <div className="d-flex align-items-center justify-content-center">
                    {loading ? (
                      <>
                        <div className="spinner-border spinner-border-sm me-3 text-white" role="status">
